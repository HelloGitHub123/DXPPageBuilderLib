#
#  Be sure to run `pod spec lint DXPPageBuilderLib.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "DXP PageBuilder SDK Manager"

  spec.homepage     = "https://github.com/HelloGitHub123/DXPPageBuilderLib"
  ...
  spec.source       = { :git => "https://github.com/HelloGitHub123/DXPPageBuilderLib.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "DXPPageBuilderLib/**/*.{h,m}"
  # spec.exclude_files = "Classes/Exclude"

  # spec.public_header_files = "Classes/**/*.h"

  spec.resource_bundles = {
    'DXPPageBuilderLib' => ['DXPPageBuilderLib/Resources/*.*']
  }
